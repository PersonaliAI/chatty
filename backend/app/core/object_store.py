"""S3-compatible object storage boundary for self-host deployments.

The adapter is lazy and private-by-default. It does not create buckets or
make an object public implicitly; operators must configure the endpoint and,
for public assets, an explicit S3_PUBLIC_URL.
"""
...
def safe_object_key(key: str) -> str:
    """Normalize an object key and reject traversal/control-character input."""
