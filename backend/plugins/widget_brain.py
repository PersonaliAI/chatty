    ...
    *,
    ...
    if scheduling_enabled:
        ...
        scheduling_block = (
            ...
            f"       Example: 'Tomorrow at 10:00 AM ({visitor_timezone or 'UTC'}) is available! To reserve your slot and send you the calendar invite, could you please share your {required_fields_str}?' (and ask once for {optional_fields_str}).\n"
            ...
            f"   - State the confirmed time based on the visitor's local timezone cleanly and naturally, showing simple time aligned with the visitor's timezone and inside brackets showing the timezone (e.g. 'Your meeting is scheduled for Thursday, September 10th at 10:00 AM ({visitor_timezone or 'UTC'})'). NEVER output 'GMT', 'GMT+...', or raw offset strings in your replies.\n"
