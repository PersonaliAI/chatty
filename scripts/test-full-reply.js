...
(async () => {
  ...
  console.log('Waiting for full response stream...');
  // Wait until typing indicator disappears and bot bubble has text
  await page.waitForTimeout(15000);
  await page.screenshot({ path: 'public/product-hunt-assets/chatty_full_reply.png' });
  await browser.close();
  console.log('Saved chatty_full_reply.png');
})();
