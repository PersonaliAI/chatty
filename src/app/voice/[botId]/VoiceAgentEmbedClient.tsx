...
export default function VoiceAgentEmbedClient({
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0b1118] text-white">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-5xl flex-col px-4 py-5 sm:px-8 sm:py-8">
        ...
        <section className="grid flex-1 items-center gap-6 lg:grid-cols-[minmax(0,0.85fr)_minmax(420px,1.15fr)]">
          ...
          <div className="relative mx-auto flex h-[min(760px,calc(100vh-112px))] min-h-[600px] w-full max-w-[560px] flex-col overflow-hidden rounded-[30px] border border-white/15 bg-white/[0.97] shadow-[0_30px_100px_rgba(0,0,0,.5)] ring-1 ring-black/20">
            <div className="flex h-16 shrink-0 items-center justify-between border-b border-black/10 bg-gradient-to-r from-[#b2622d] to-[#c67139] px-5 text-white">
              <div className="flex items-center gap-3">
                <div className="grid size-9 place-items-center rounded-full bg-white text-[#b2622d] shadow-sm">
              ...
              <span className="rounded-full bg-white/15 px-2.5 py-1 text-[10px] font-semibold tracking-wide">LIVE CALL</span>
            </div>
