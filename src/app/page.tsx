      ...
      <div className="max-w-[1200px] mx-auto px-5 sm:px-9">
        ...
        <section className="relative pt-6 sm:pt-10 pb-14 sm:pb-18 text-center">
          ...
          <div className="flex flex-wrap gap-3.5 items-center justify-center mt-9">
            ...
            <Link href="/voice/ad32f373-7694-43f4-9465-f8d65ce291e3" className="inline-flex items-center gap-2 rounded-full px-5 py-3.5 text-[15px] font-medium" style={{ fontFamily: "var(--font-heading)", color: "var(--color-accent)" }}>
              Talk to voice agent
        ...
        <section className="py-8 pb-16 sm:pb-20">
          <div className="rounded-[28px] sm:rounded-[44px] py-12 sm:py-16 px-7 sm:px-16 text-center relative overflow-hidden" style={{ background: "var(--color-accent)" }}>
            ...
            <div className="flex gap-3.5 justify-center flex-wrap mt-7">
              ...
              <Link href="/voice/ad32f373-7694-43f4-9465-f8d65ce291e3" className="inline-flex items-center gap-2 rounded-full px-6 py-3.5 text-[15px] font-medium border" style={{ fontFamily: "var(--font-heading)", borderColor: "color-mix(in srgb, var(--color-bg) 60%, transparent)", color: "var(--color-bg)" }}>
                Talk to voice agent
                <AudioWaveform className="size-4" />
              </Link>
            </div>
