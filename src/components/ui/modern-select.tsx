      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={`absolute z-50 mt-1.5 w-full min-w-[180px] bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl shadow-xl overflow-hidden ${
