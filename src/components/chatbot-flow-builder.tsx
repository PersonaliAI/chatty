...
import { Play, MessageSquare, HelpCircle, UserCheck, PhoneCall, Trash2, Save, Plus, Loader2, Sparkles } from "lucide-react";
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (schema.nodes && schema.edges) {
          ...
          setAiPrompt("");
          alert("Flow successfully generated by AI agent!");
        } else {
          alert("Invalid flow structure returned by AI.");
        }
      } else {
        const body = await res.json();
        alert(body.detail || "Failed to generate flow with AI.");
      }
    } catch {
