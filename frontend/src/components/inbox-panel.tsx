...
import { Loader2, Send, RefreshCw, Inbox as InboxIcon, Bot, Headphones, Trash2, Paperclip, Smile, Mic, Square, X, Check, AlertCircle, Zap, Plus, Pencil, Settings2 } from "lucide-react";
